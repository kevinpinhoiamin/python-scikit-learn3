...
resultado_one_vs_rest = fit_and_predict('OneVsRestClassifier', modelo_one_vs_rest, treino_dados, treino_marcacoes, teste_dados, teste_marcacoes)
...
resultado_one_vs_one = fit_and_predict('OneVsOneClassifier', modelo_one_vs_one, treino_dados, treino_marcacoes, teste_dados, teste_marcacoes)
...
resultado_ada_boost = fit_and_predict('AdaBoostClassifier', modelo_ada_boost, treino_dados, treino_marcacoes, teste_dados, teste_marcacoes)
